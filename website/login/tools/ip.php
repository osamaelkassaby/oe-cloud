...
function ipInfo_mysql_from_session($username , $userId){
   include("constants.php");
   ...
   $date = date('Y-m-d');
   $time = date('H:i:s');
   $sql = "INSERT INTO `log_users`(`username` , `user_id` , `date` , `time` , `ip` , `device` , `country` , `city` , `region` , `loc`) VALUES ('$username' , '$userId', '$date' , '$time' , '$userIP', '$os' , '$country' , '$city' , '$region' , '$loc')";
